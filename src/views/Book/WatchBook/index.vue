      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-5 col-xs-12 col-12">
              <div class="cover-image">
                <img v-if="book?.cover_image" :src="URL_IMAGE + book?.cover_image" alt="Ảnh bìa sách" style="width: 100%; height: 400px; object-fit: cover">
          ...
          <div class="content pb-3">
            <div class="mp3">
              <div class="mt-3 mb-2"><b>Mp3</b></div>
